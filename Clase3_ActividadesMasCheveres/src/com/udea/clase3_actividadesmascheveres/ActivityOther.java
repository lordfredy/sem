...
public class ActivityOther extends Activity {
	...
	/**
	 * escribimos el nombre del personaje que fue seleccionado en la actividad anterior, hacemos una
	 * serie de valdiaciones para la informacion que llega
	 */
	private void escribirPersonaje() {
	
		// tomamos el intent que nos trajo hasta aca
		Intent intent = getIntent();
		// debemos estar seguros de que el intente posee informacion antes de ir a consultarlo
		if (intent.getExtras() != null) {
			
			// como ya sabemos que el intente llega con informacion, para efecto del ejemplo,
			...
			// si el intent no posee el bundle indicado, para efectos del ejercicio y la practica
			// vamos a preguntar si tiene un extra llamado personaje
			else {
